...
backtest/engine.py
------------------
Shared trading primitives used by both backtester.py and confluence.py.

Extracted to eliminate ~200 lines of duplication.  Both backtesters
call these functions instead of inlining identical logic.
